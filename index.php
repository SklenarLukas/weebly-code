    ...
    <div class="main-wrap">
        ...
        <section class="tools">
            <div class="container">
                ...
                <div class="row">
                    <div class="col">
                        <img src="https://lsklenar.weebly.com/uploads/1/4/3/7/143782816/bell_1.jpg" class="img-fluid"
                            alt="...">
                        <h5>Cenové upozornenie</h5>
                        <p>Zapnite si cenové upozornenie a nenechajte si ujsť prijateľnú cenu vašej dovolenky.</p>
                    </div>
                    <div class="col">
                        <img src="https://lsklenar.weebly.com/uploads/1/4/3/7/143782816/doc_1.jpg" class="img-fluid"
                            alt="...">
                    ...
                    <div class="col">
                        <img src="https://lsklenar.weebly.com/uploads/1/4/3/7/143782816/plane_1.jpg" class="img-fluid"
                            alt="...">
                        <h5>Poistenie</h5>
        ...
        <section class="reviews">
            <div class="container">
                ...
                <div class="stars">
                    <img src="https://lsklenar.weebly.com/uploads/1/4/3/7/143782816/stars_1.png" class="img-fluid"
                        alt="...">
                    <p>Ivana Bieliková</p>
                </div>
            </div>
